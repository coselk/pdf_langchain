...
with gr.Blocks(title="PdfReader") as webui:
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            llm_model = gr.Dropdown(label="LLM Model", choices=["chatglm2-6b"], value="chatglm2-6b")
...
if __name__ == '__main__':
    webui.launch(inline=False, share=True, debug=True, server_name="127.0.0.1", server_port=7788,
                  show_error=True)
